...
public class ContinuousMovementApplying : MonoBehaviour
{
    ...
    void Start()
    {
        timeOffset = Time.time - float.Parse(transform.parent.gameObject.GetComponent<ContinuousMovementStoring>().movements[0][2]);
    ...
    void Update()
    {
        var moveStorage = transform.parent.gameObject.GetComponent<ContinuousMovementStoring>();
